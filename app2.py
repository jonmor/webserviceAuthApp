...
if __name__ == "__main__":
    config = uvicorn.Config("app2:secure_router", port=8443,host="0.0.0.0", ssl_certfile="certs/server.crt",ssl_keyfile="certs/server.key",ssl_ca_certs="certs/ca.crt", log_level="info")
